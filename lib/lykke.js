...
/**
 * Method to get rates fol all or one asset pair for a specified period
...
/**
 * Method to get trade volumes for all available asset pairs
 * @return {Promise} Return a promise
 */
LykkePublicAPI.prototype.market = function() {
    return this._get(API_BASE_PATH + 'Market');
};

/**
 * Method to get trade volume for asset
 * @param  {String} assetPairId    Asset Pair Id
 * @return {Promise} Return a promise
 */
LykkePublicAPI.prototype.marketAsset = function(assetPairId) {
    return this._get(API_BASE_PATH + 'Market/' + assetPairId);
};
 ...
 * @return {Promise} Return a promise
 */
LykkePublicAPI.prototype.marketCapitalizationAsset = function(assetPairId) {
