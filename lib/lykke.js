 ...
 * @return {Promise}          Returns a promise
 */
LykkeWalettAPI.prototype._get = function(url, params) {
 ...
 * @return {Promise}          Returns a promise
 */
LykkeWalettAPI.prototype._post = function(url, params, config) {
 ...
 * @return {Promise}              Returns a promise
 * @example
 * walettAPI.accountExist('test@me.com');
 */
 ...
 * @return {Promise}                Returns a promise
 * @example
 * walettAPI.auth('test@me.com', 'testpassword');
 */
...
/**
 * Method to check if Lykke Walett API is alive
 * @constructor
 * @return {Promise}    Returns a promise
 * @example
 * walettAPI.isAlive();
 */
LykkeWalettAPI.prototype.isAlive = function() {
    return this._get(API_BASE_PATH + 'IsAlive');
};
