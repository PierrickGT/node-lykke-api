...
describe('Lykke Wallet API', () => {
    it('should check if an account exist', done => {
        ...
        testRequest(walettAPI.accountExist('test@me.com'), done);
    });
